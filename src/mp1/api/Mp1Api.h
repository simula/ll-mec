...
class  Mp1Api {
public:
    Mp1Api(std::shared_ptr<Pistache::Rest::Router>);
    virtual ~Mp1Api() {}
    void init();
...
private:
    ...
    virtual void delete_mp1_traffic_all(const Mp1Traffic &mp1Traffic, Pistache::Http::ResponseWriter &response) = 0;
    ...
    virtual void delete_mp1_traffic_imsi(const Mp1TrafficImsi &mp1TrafficImsi, Pistache::Http::ResponseWriter &response) = 0;
    ...
    /// </remarks>
    /// <param name="mp1Traffic"></param>
    virtual void post_mp1_traffic_all(const Mp1Traffic &mp1Traffic, Pistache::Http::ResponseWriter &response) = 0;
    ...
    /// </remarks>
    /// <param name="mp1TrafficImsi"> (optional)</param>
    virtual void post_mp1_traffic_imsi(const Mp1TrafficImsi &mp1TrafficImsi, Pistache::Http::ResponseWriter &response) = 0;
