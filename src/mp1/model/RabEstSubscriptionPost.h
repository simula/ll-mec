...
*/
/*
 * RabEstSubscriptionPost.h
 *
 * 
 */

#ifndef RabEstSubscriptionPost_H_
#define RabEstSubscriptionPost_H_
...
/// 
/// </summary>
class  RabEstSubscriptionPost
{
public:
    RabEstSubscriptionPost();
    virtual ~RabEstSubscriptionPost();

    void validate();

    /////////////////////////////////////////////
    /// RabEstSubscriptionPost members
    ...
    friend void to_json(nlohmann::json& j, const RabEstSubscriptionPost& o);
    friend void from_json(const nlohmann::json& j, RabEstSubscriptionPost& o);
protected:
...
#endif /* RabEstSubscriptionPost_H_ */
