...
void Mp1ApiImpl::rab_est_subscription_subscriptions_post(const RabEstSubscriptionPost &rabEstSubscriptionPost, Pistache::Http::ResponseWriter &response) {
	...
	Link link;
	link.setSelf(m_rib.get_mp1_server_url() + base + "/rni/" + subscriptionId);
...
void Mp1ApiImpl::services_get(const Pistache::Optional<std::vector<std::string>> &serInstanceId, const Pistache::Optional<std::vector<std::string>> &serName, const Pistache::Optional<std::string> &serCategoryId, Pistache::Http::ResponseWriter &response) {
